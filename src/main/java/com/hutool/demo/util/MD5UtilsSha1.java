...
/**
 * Description: MD5加盐加密 的变种： MD5和SHA-1混合加盐加密
 *
 * @author jason
 * @date 2019-07-21 13:57
 */
public class MD5UtilsSha1 {
    ...
    public static void main(String[] args) {
        ...
        // 获取加盐后的MD5值
        String ciphertext = MD5UtilsSha1.getSaltMd5AndSha(plaintext);
        System.out.println("加盐后MD5：" + ciphertext);
        System.out.println("是否是同一字符串:" + MD5UtilsSha1.getSaltverifyMd5AndSha(plaintext, ciphertext));
    }
